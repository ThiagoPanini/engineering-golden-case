...
module "aws_iam_role" {
  ...
  role_name                   = "egc-role-get-b3-active-tickers"
  trust_policy_filepath       = "${path.module}/iam_assets/trust_policies/trust-lambda.json"
  policy_templates_source_dir = "${path.module}/iam_assets/policy_templates"
